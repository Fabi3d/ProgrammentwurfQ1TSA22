...
DIV=12,							% Satzspiegeleinstellung, 12 ist Standar bei KOMA%BCOR=6mm,						% Bindekorrektur, die den Seitenspiegel um 6mm nach rechts verschiebt,
...
\newcommand{\untertitel}{Entwicklung eines rudimentären Zeitscheibensystems in C}
\newcommand{\arbeit}{}
\newcommand{\studiengang}{Embedded Systems }
\newcommand{\studienrichtung}{Automotive Engineering}
\newcommand{\studienschwerpunkt}{}
\newcommand{\autor}{Fabian Klotz}
\newcommand{\matrikelnr}{}
\newcommand{\kurs}{TSA22}
\newcommand{\firma}{}
\newcommand{\abgabe}{09.04.2023}
\newcommand{\betreuerdhbw}{Prof. Dr. Florian Leitner-Fischer}
